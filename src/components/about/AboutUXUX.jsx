...
<div className={`flex  items-center justify-between`}>
      ...
      <div className="">
    <h1 className={`${textwhite} ${headingText} mx-auto w-[100%]  text-start `}>UI/UX<span className="text-purple-500 font-semibold"> Techniques</span> </h1>

    <p className={`w-[100%] sm:w-[60%] mt-8 text-white leading-7 text-[16px]  `}>We develop customize web designs to meet the demands and needs of all types of customers, it includes both small custom design websites to highly advanced online stores to make it evident that we are 360 degree full scale custom software development company. We got our clients secured as our creative team discuss the structure by giving innovative ideas and suggestion.</p>
