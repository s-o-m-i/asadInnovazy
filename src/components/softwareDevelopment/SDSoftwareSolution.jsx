...
<div onClick={()=>handleShowSoftSolution(i)} className="s-custom-sol-box s_faq background-glass py-4 px-4 border-l-2 border-orange-500 flex  items-center justify-between overflow-hidden">
