...
const QAServices = () => {
 ...
 <div className="flex sm:justify-center">
    ...
    <StaticImage src='../../assets/images/qa-service-one.webp' className='rounded-tl-lg'/>
        </div>
        <div className="sm:col-span-6 col-span-12 text-white px-8 pb-4 pt-8 background-glass my_glassMorhism rounded-tr-lg">
        <h1 className={`text-3xl text-white  `}> <span className=''>Manual </span>testing
        </h1>
    ...
    <div className="grid grid-cols-12  ">
        ...
        <div className="sm:col-span-6 col-span-12 background-glass text-white px-8 pb-4 pt-8  my_glassMorhism rounded-bl-lg">
    <h1 className={`text-3xl text-white  `}> <span className=''>Automated </span>testing
    </h1>
    ...
    <div  className="flex left-pointer items-center gap-4 text-white  mt-3 w-full">
        ...
        <div className="sm:col-span-6 col-span-12 ">
    <StaticImage src='../../assets/images/qa-service-two.webp' className='rounded-br-lg'/>
        </div>
    </div>
    </>
  )
